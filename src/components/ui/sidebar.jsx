...
export const DesktopSidebar = ({
  ...
  return (<>
    <motion.div
      className={cn(
        "h-screen px-4 py-4 hidden  lg:flex lg:flex-col  dark:bg-neutral-800 w-[300px] flex-shrink-0   bg-[url(/images/sidebar_img.webp)]  bg-fixed bg-no-repeat bg-black  ",
        className
      )}
      animate={{
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className={cn(
              "fixed h-full w-full inset-0  dark:bg-neutral-900 p-10 z-[100] flex flex-col justify-between  bg-[url(/images/sidebar_img.webp)]  bg-fixed bg-no-repeat bg-cover bg-black ",
              className
            )}>
            <div
