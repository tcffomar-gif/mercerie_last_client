...
const Page = () => {
  const t = useTranslations('proposMagasin');
  ...
  return (
    ...
    <div className="max-w-4xl w-full bg-white dark:bg-gray-800 rounded-lg shadow-2xl p-8 space-y-8">
      ...
      <div className="space-y-6">
        <h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-200">
          {t('pourquoiNousChoisir.title')}
        </h2>
        <ul className="list-disc list-inside space-y-4 text-lg text-gray-600 dark:text-gray-300">
          {t.raw('pourquoiNousChoisir.items').map((item, index) => (
      ...
      <div className="space-y-6">
        <h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-200">
          {t('notreEngagement.title')}
        </h2>
        <p className="text-lg text-gray-600 dark:text-gray-300">
          {t('notreEngagement.content')}
        </p>
      </div>
