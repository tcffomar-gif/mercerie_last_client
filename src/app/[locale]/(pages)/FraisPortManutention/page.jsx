...
export const metadata = {
  title: "Frais de Port et de Manutention",
...
const Page = () => {
  const t = useTranslations('FraisPortManutention');
    ...
    <div className="max-w-4xl w-full bg-white dark:bg-gray-800 rounded-lg shadow-2xl p-8 space-y-8">
      ...
      <div className="space-y-6">
        ...
        <p className="text-lg text-gray-600 dark:text-gray-300">
          {t('expedition.content')}
        </p>
      </div>
  
      {/* Section Méthodes d'expédition */}
      <div className="space-y-6">
        <h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-200">
          {t('methodesExpedition.title')}
        </h2>
        <p className="text-lg text-gray-600 dark:text-gray-300">
          {t('methodesExpedition.content')}
        </p>
      </div>
